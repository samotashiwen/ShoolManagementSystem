 ...
 * @author sogobanjo
 */
public class ExamAttendanceRegister extends javax.swing.JDialog {

    /**
     * Creates new form ExamAttendanceRegister
     */
...
//        comboSession1.setEnabled(false);
    ...
    public ExamAttendanceRegister(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        fill_list(ComboExamDate,Rset);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Exam Attendance Register");
        ...
        ButtonSaveScore.setText("Save Attendance");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(ButtonSaveScore, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE))
...
//        stmt = "insert into ca_exam (exam_date, academic_session_id, academic_term_id, class_id, student_id,subject_id, score, exam_type) values ";
        stmt = "insert into exam_attendance (exam_setup_id, student_id) values ";
        ...
        dbops.createConnection();
           ...
           // System.out.println(stmt);   // Print the SQL statement for debugging purpose
            ...
            if(dbops.error_msg.trim().length()==0)
                JOptionPane.showMessageDialog(this,  " Exam Attendance Successfuly Saved");
            else
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExamAttendanceRegister.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ExamAttendanceRegister dialog = new ExamAttendanceRegister(new javax.swing.JFrame(), true);
